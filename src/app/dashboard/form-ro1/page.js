...
export default function FormRO1Page() {
  ...
  return (
    <div className="animate-fadeIn">
      <h1 style={{ marginBottom: 24 }}>📄 {t('formRO1')}</h1>
      <div className="card"><div className="card-body">
        <div className="alert alert-info" style={{ marginBottom: 20 }}>
          ℹ️ {lang === 'bs' ? 'Obrazac RO1 - Prijava osiguranika za pregled radne opreme.' : 'Form RO1 - Insured person application for equipment inspection.'}
        </div>
