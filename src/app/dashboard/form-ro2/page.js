      ...
      <div className="animate-fadeIn">
        ...
        <div className="card" style={{ marginBottom: 16 }}>
          <div className="card-body scrollable-toolbar" style={{ padding: 0, gap: 12 }}>
            <button className="btn btn-primary" onClick={handleNew} title={t('dodajNoviRo2Obrazac')}>
              + {t('noviRo2')}
            </button>
  ...
  return (
    <div className="animate-fadeIn">
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
        ...
        <h1 style={{ margin: 0 }}>📄 {editingId ? (t('urediUputnicuRo2')) : (t('novaUputnicaRo2'))}</h1>
      </div>
      <DialogRenderer />
        ...
        <div className="card">
          <div className="card-body">
            <div style={sectionTitle}>
              {t('uputniceZaProvjeruRadneSposobnosti')}
            </div>
            ...
            <div style={{ marginBottom: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', fontSize: '0.84rem' }}>
                <span style={{ fontWeight: 600 }}>
                  {t('radnoMjestoSPosebnimUvjetima')}
                </span>
