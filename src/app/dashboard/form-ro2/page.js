      ...
      <div className="animate-fadeIn">
        ...
        <div className="card" style={{ marginBottom: 16 }}>
          <div className="card-body scrollable-toolbar" style={{ padding: 0, gap: 12 }}>
            <button className="btn btn-primary" onClick={handleNew} title={lang !== 'en' ? 'Dodaj novi RO-2 obrazac' : 'Add new RO-2 form'}>
              + {lang !== 'en' ? 'Novi RO-2' : 'New RO-2'}
            </button>
              ...
              <table className="data-table" style={{ width: '100%' }}>
                <thead>
                  <tr>
                    ...
                    <th>{lang !== 'en' ? 'Čl.3 točke' : 'Art.3 point'}</th>
                    <th>{lang !== 'en' ? 'Radni staž' : 'Experience'}</th>
                    <th>{lang !== 'en' ? 'Promjena RM' : 'Changed pos.'}</th>
                  </tr>
                </thead>
                <tbody>
                  {sorted.length === 0 ? (
  ...
  return (
    <div className="animate-fadeIn">
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
        ...
        <h1 style={{ margin: 0 }}>📄 {editingId ? (lang !== 'en' ? 'Uredi uputnicu RO-2' : 'Edit RO-2') : (lang !== 'en' ? 'Nova uputnica RO-2' : 'New RO-2')}</h1>
      </div>
      <DialogRenderer />
        ...
        <div className="card">
          <div className="card-body">
            ...
            <div style={{ marginBottom: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', fontSize: '0.84rem' }}>
                <span style={{ fontWeight: 600 }}>
                  {lang !== 'en' ? 'Radno mjesto s posebnim uvjetima prema čl3, točke' : 'Workplace with special conditions per art.3, points'}
                </span>
            ...
            <div style={{ marginBottom: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', fontSize: '0.84rem' }}>
                <span style={{ fontWeight: 600 }}>
                  {lang !== 'en' ? 'Od posljednje ocjene radne sposobnosti dne:' : 'Since last fitness assessment on:'}
                </span>
            ...
            <div style={{ marginBottom: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: '0.84rem' }}>
                <span style={{ fontWeight: 600 }}>
                  {lang !== 'en' ? 'Radni staž na radnom mjestu koji obavlja:' : 'Work experience in current position:'}
                </span>
