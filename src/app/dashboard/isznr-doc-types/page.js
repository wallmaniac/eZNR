...
export default function ISZNRDocTypesPage() {
  ...
  return (
    <><DialogRenderer /><div className="animate-fadeIn">
      <h1 style={{ marginBottom: 24 }}>🗃️ {t('documentTypes')}</h1>
      {showForm && (
      ...
      <div className="card"><div className="card-body">
        <div style={{ display: 'flex', gap: 12, marginBottom: 16 }}><button className="btn btn-primary btn-sm" onClick={handleNew}>+ {lang === 'bs' ? 'Novi tip dok.' : 'New Doc Type'}</button></div>
