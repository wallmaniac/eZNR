...
const APP_KNOWLEDGE = {
    pages: [
        ...
        { path: '/dashboard/injuries', label_bs: 'Popis povreda', label_en: 'Injury List', desc_en: 'Full list of recorded workplace injuries', desc_bs: 'Cjeloviti popis evidentiranih povreda na radu' },
        ...
        { path: '/dashboard/equipment', label_bs: 'Pregledi opreme', label_en: 'Equipment Exam List', desc_en: 'List of all scheduled and completed equipment inspections', desc_bs: 'Lista svih planiranih i izvršenih pregleda opreme' },
