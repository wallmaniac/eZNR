                                ...
                                {mobileProfileTab === 'profile' && (
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                                        <div style={{ padding: '12px 16px', background: 'var(--bg-page)', borderRadius: 12, border: '1px solid var(--border)' }}>
                                            <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginBottom: 4 }}>{t('imeIPrezime1')}</div>
                                            <div style={{ fontWeight: 600, fontSize: '0.9rem' }}>{user?.firstName} {user?.lastName}</div>
                                        </div>
                                        <div style={{ padding: '12px 16px', background: 'var(--bg-page)', borderRadius: 12, border: '1px solid var(--border)' }}>
                                            <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginBottom: 4 }}>{t('emailKorisnickoIme')}</div>
                                        ...
                                        <div style={{ padding: '12px 16px', background: 'var(--bg-page)', borderRadius: 12, border: '1px solid var(--border)' }}>
                                            <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginBottom: 4 }}>{t('aktivnaKompanija')}</div>
                                ...
                                {mobileProfileTab === 'admin' && isAdmin && (
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                                        <button onClick={() => { setMobileProfileOpen(false); onMobileClose?.(); router.push('/dashboard/admin/users'); }} style={{
                                            ...
                                            <div>
                                                <div>{t('upravljanjeKorisnicima')}</div>
                                                <div style={{ fontSize: '0.72rem', color: 'var(--text-muted)', fontWeight: 400 }}>{t('dodajUrediIliObrisiKorisnicke')}</div>
                                            </div>
                                        </button>
                                        <button onClick={() => { setMobileProfileOpen(false); onMobileClose?.(); router.push('/dashboard/admin/companies'); }} style={{
                                            ...
                                            <span style={{ fontSize: '1.3rem' }}>🏢</span>
                                            <div>
                                                <div>{t('upravljanjeFirmama')}</div>
                                                <div style={{ fontSize: '0.72rem', color: 'var(--text-muted)', fontWeight: 400 }}>{t('dodajUrediIliObrisiPodatke')}</div>
                                            </div>
                                        </button>
                                    </div>
                                )}
